...
<div class="left">
    <div class="left_articles">        
        ...
        <table cellspacing="0" cellpadding="0" class="table-data" style="width: 850px; margin: 0px;">
            <tr><td class="head">No</td><td class="head">Kode Barang</td><td class="head">Nama Barang</td><td class="head">Kelompok<br /> Barang</td><td class="head">HM</td><td class="head">Harga Barang</td><td class="head">Qty</td><td class="head">Diskon</td><td class="head">Jumlah</td></tr>
            <?php 
            for($i=0; $i<15;)
            echo '<tr class="row-data">
                ...
                <td ><input type="text" name="harga[]" id="harga_'.$i.'" style="width:100px;" onkeyup="hitungJumlah('.$i.')" /></td>
            ...
            ?>
            <tr><td colspan="6" style="text-align:right;height: 30px;">TOTAL</td><td><span id="total_qty"></span></td><td></td><td><span id="total_jumlah"></span></td></tr>
        </table>
        <br />
