...
<div class="left">
    <div class="left_articles">        
        ...
        <table class="table-data" cellspacing="0" cellpadding="0" style="width:950px">
            <tr>
                <td class="head"> No </td><td class="head"> Tanggal Masuk</td><td class="head"> Kode Barang </td><td class="head"> Nama Barang </td><td class="head">HM</td><td class="head">Harga Barang</td>
